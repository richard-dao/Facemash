...
//Limit First Picks
/*$queryAlt = "SELECT * FROM images WHERE rank <= 50";
$resultAlt = @mysqli_query($connection, $queryAlt);
$altArray = array();
while($row2 = mysqli_fetch_object($resultAlt)){
    $altArray[] = (object) $row2;
}
$images[0] = $altArray[rand(0, count($altArray)-1)];*/
...
<table>
	...
	<tr>
        ...
        <td valign="top" class="image"><a href="rateleft.php"><img src="images/<?=$images[0]->filename?>" /></a></td>
        
		<td valign="top" class="image"><a href="rateright.php"><img src="images/<?=$images[1]->filename?>" /></a></td>
	</tr>
    <tr>
...
<br>
<button style = "font-family:Arial, Helvetica, sans-serif;font-size: 40px; padding: 2%; text-align:center;" onclick="location.href='rankings.php'">Current Rankings</button>
<br>
<br>
<br>
    </div>
