...
<div style = "margin: 0; padding: 0; border-top: 1px solid black; border-bottom: 1px solid black; background-color:white;">
    ...
    <div style = "margin: 0; padding: 0;">
        <ul>
            <li2>
            <h1 style="margin: 5%; background-color: #DC4548; border: 5px solid black; font-size: 15px;">Need Some Help? Contact Us!</h1>
            <br>
            <p>Email Us: support@gmail.com</p>
            <p>Text Us: 1-800-000-0000</p>
            <p>Follow Us on Instagram: @instagram</p>
            <p>Follow Us on Twitter: @twitter</p>
            <p>Like Our Facebook: @facebook</p>
